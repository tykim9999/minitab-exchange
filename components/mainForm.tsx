  ...
  const Popup = () => (
    <div className="popup-overlay">
      <div className="popup-content">
        <div
          className="popup-description border border-white p-4"
      ...
      {!isSubmitted ? (
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          <div className="grid gap-4">
            ...
            <div className="grid grid-cols-4 items-center gap-4">
              ...
              <textarea
                ...
                className="col-span-3 border border-gray-300 p-2 rounded text-black resize-none" // 텍스트 색상 검정, 크기 고정
          ...
          <div className="flex justify-end">
            <button
              type="submit"
              className={`bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:from-blue-600 hover:to-purple-700 hover:shadow-xl transition-all duration-300 transform hover:scale-105 ${
